...
#loop for creating the lines labelled with numbers
for sp in range(15): 
  speed(10)
 #setting the speed
  write(sp)
...
ankur.color('red') #setting the color to green for the first turtle
...
turtleVar.color('green') #setting the color of the turtle as "blue"
...
turtleWar = Turtle() #inheriting the last turtle
turtleWar.color('yellow') #setting the color of the turtle as "yellow"
turtleWar.shape('turtle') #declaring the shape of the turtle
turtleWar.penup() #not ready to draw
turtleWar.goto(-160,40) #positioning
turtleWar.pendown() #ready
...
for turn in range(100): #loop for the race
  ...
  turtleWar.forward(randint(1,5)) #setting the speed randomly with the "random" module
